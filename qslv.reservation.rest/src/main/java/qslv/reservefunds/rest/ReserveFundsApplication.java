...
public class ReserveFundsApplication {
	private static final Logger log = LoggerFactory.getLogger(ReserveFundsApplication.class);

	public static void main(String[] args) {
		SpringApplication application = new SpringApplication(ReserveFundsApplication.class);
